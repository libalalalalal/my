...
<head>
    ...
    <link href="<%=basePath%>static-res/bootstrap-3.3.7-dist/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet">
    <script src="<%=basePath%>static-res/bootstrap-3.3.7-dist/datetimepicker/bootstrap-datetimepicker.min.js"></script>
    <script src="<%=basePath%>static-res/bootstrap-3.3.7-dist/datetimepicker/bootstrap-datetimepicker.zh-CN.js"></script>
</head>
<style>
    body {
        ...
        <div class="panel panel-info">
            ...
            <form action="<%=basePath%>addtostore" method="post">
                <table class="table">
                    ...
                    <tr>23336666666666666666666666666666666
                        <td>条形码（10位数字）:</td>
